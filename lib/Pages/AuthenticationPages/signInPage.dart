...
import 'package:raymond_test/Components/Links/links.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  String _signupButtonTextStatus = 'Sign in';
  ...
  void accountExistFunction(){
    setState(() {
      _signupButtonTextStatus = "Sign in";
  ...
  void successfulSignInFunction(){
    setState(() {
      _signupButtonTextStatus = "Sign in Successful";
      _isLoading = GlobalVariables.falseValue;
    });
    // show success first
    showSnackBar(
    ...
    // navigate to statusChecker page
    Get.offNamed(RouteClass.statusCheckerPage);
  }
  void invalidCredentialsFunction(){
    setState(() {
      _signupButtonTextStatus = "Sign in";
      _isLoading = GlobalVariables.falseValue;
    });
  ...
  void unsuccessfulAuthenticationFunction(){
    setState(() {
      _signupButtonTextStatus = "Sign in";
      _isLoading = GlobalVariables.falseValue;
    });
    ...
    showSnackBar(
      context: context,
      message: 'Unsuccessful authentication! Please try again...',
      messageFontWeight: FontWeight.w500,
      messageColor: GlobalVariables.whiteColor,
      snackBarBackgroundColor: GlobalVariables.fadedBlackColor,
    );
      ...
      body: SafeArea(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: const AssetImage(
                "${ImageStringGlobalVariables.imagePath}${ImageStringGlobalVariables.signInBackgroundImage}",
              ),
              fit: BoxFit.cover,
              colorFilter: ColorFilter.mode(
                GlobalVariables.buttonColor.withOpacity(SizeGlobalVariables.point_two),
                BlendMode.dstATop,
              ),
            ),
          ),
          child: Stack(
            children: [
              Positioned(
                top: SizeGlobalVariables.hundred.h,
                        ...
                        onClickFunction: _isLoading ? (){
                          ...
                          if (_emailError == null && _passwordError == null) {
                           ...
                           _authenticationService.signIn(
                               ...
                               successfulSignInFunction: successfulSignInFunction,
                               invalidCredentialsFunction: invalidCredentialsFunction,
                               dioExceptionFunction: dioExceptionFunction,
                               unsuccessfulAuthentication: unsuccessfulAuthenticationFunction,
                           );
                      ...
                      Row(
                        children: [
                          ...
                          Links(
                              ...
                              onClickFunction: (){
                                Get.offNamed(RouteClass.signUpPage);
                              }
                          ),
                        ],
                      )
